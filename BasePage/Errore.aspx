<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Errore.aspx.vb" Inherits="Immobiliare_Web.Errore"
    MasterPageFile="~/Start/Immobiliare.Master" %>
                ...
                <table style="border: solid 0px; width: 93%;">
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            ...
                            &nbsp;
                            <asp:HyperLink ID="hlProsegui" runat="server" NavigateUrl=" " class="btn btn-primary"
                                Visible="false">Prosegui</asp:HyperLink>
                        </td>
                    </tr>
                </table>
            </div>
