<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Start/Immobiliare.Master"
    CodeBehind="Banner_Lista.aspx.vb" Inherits="Immobiliare_Web.Banner_Lista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="row row_padding_top">
        <div class="col-md-12 table-responsive">
            <telerik:RadGrid ID="RGBanner" AutoGenerateColumns="False" CssClass="" runat="server"
                ...
                <MasterTableView ShowFooter="false" Width="100%" DataKeyNames="banner_key" AllowMultiColumnSorting="True">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn SortExpression="banner_titolo" UniqueName="banner_titolo"
                            HeaderText="Titolo" DataField="banner_titolo" HeaderStyle-Width="30%" AllowFiltering="true"
