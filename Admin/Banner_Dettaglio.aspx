<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Start/Immobiliare.Master"
    CodeBehind="Banner_Dettaglio.aspx.vb" Inherits="Immobiliare_Web.Banner_Dettaglio" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="box-body" id="div_banner" runat="server">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="Banner_Lista.aspx">TORNA ALLA LISTA</a></li>
                    </ul>
                        ...
                        <asp:Repeater ID="rpt_lingue_tabs" runat="server">
                            <ItemTemplate>
                                ...
                                <div class="tab-pane" id="li_tab_a" runat="server">
                                    ...
                                    <cc:rtextbox id="txt_sottotitolo" runat="server" maxlength="128" autopostback="false"
                                        label="Sottotitolo" icon="" />
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
                    <cc:rtextbox ID="txt_link_url" runat="server" Label="Link" />
