<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Start/Immobiliare.Master"
    CodeBehind="Tag_Dettaglio.aspx.vb" Inherits="Immobiliare_Web.Tag_Dettaglio" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-horizontal">
                ...
                <div class="box-body" id="div_banner" runat="server">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="Tag_Lista.aspx">TORNA ALLA LISTA</a></li>
                    </ul>
                        ...
                        <asp:Repeater ID="rpt_lingue_tabs" runat="server">
                            <ItemTemplate>
                                ...
                                <div class="tab-pane" id="li_tab_a" runat="server">
                                    <cc:rtextbox id="txt_tag" runat="server" maxlength="128" autopostback="false"
                                        label="Inserimento titolo" icon="" required="true" required_help="Campo Obbligatorio" />
                                    <cc:rtextbox id="txt_gruppo" runat="server" maxlength="128" autopostback="false"
                                        label="Inserimento gruppo del tag" icon="" />
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
